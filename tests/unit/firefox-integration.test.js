...
describe('Firefox Extension Integration', () => {
  test('browser-compat.js initializes correctly in Firefox environment', () => {
    ...
    global.navigator = { userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/120.0' };
  ...
  test('content.js works with Firefox browser API via compatibility layer', async () => {
    ...
    // Mock Firefox browser API
    let storageData = { enabled: true, totalBlockedCount: 0 };
    global.browser = {
      storage: {
        local: {
          get: (keys) => {
  ...
  test('popup.js works with Firefox browser API', async () => {
    ...
    // Mock Firefox browser API
    let storageData = { enabled: true, totalBlockedCount: 5 };
    global.browser = {
      storage: {
        local: {
